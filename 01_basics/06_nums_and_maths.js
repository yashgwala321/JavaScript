...
console.log(Math.round(4.6)); //=> round mtlb jase:- 4.6 ho to uska 5 ho jayega and 9.6 ho to 10 ho jayega. 
console.log(Math.ceil(4.2));
console.log(Math.floor(4.9)); //=> floor mtlb ko sabse last ki value ho vo jase:- 4.9 hai to uska 4 ho jayega. 

console.log(Math.min(4,2,8,15)); //=> min me jo sabse chhota number hoga vo aayega jase:- 2 

console.log(Math.max(4,2,8,15)); //=> max me jo sabse bada number hoga vo aayega jase:- 15
